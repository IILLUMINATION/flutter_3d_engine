...
fn wire__crate__api__simple__handle_pointer_down_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "handle_pointer_down",
            port: None,
        ...
        move || {
            ...
            let api_screen_width = <f32>::sse_decode(&mut deserializer);
            let api_screen_height = <f32>::sse_decode(&mut deserializer);
            deserializer.end();
            transform_result_sse::<_, ()>((move || {
                let mut api_scene_guard = None;
                let decode_indices_ =
                ...
                let mut api_scene_guard = api_scene_guard.unwrap();
                let output_ok = Result::<_, ()>::Ok(crate::api::simple::handle_pointer_down(
                    &mut *api_scene_guard,
                    api_screen_x,
                    api_screen_y,
                    api_screen_width,
...
fn wire__crate__api__simple__handle_pointer_move_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "handle_pointer_move",
            port: None,
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Sync,
        },
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let output_ok = Result::<_, ()>::Ok({
                    crate::api::simple::handle_pointer_move(
                        &mut *api_scene_guard,
                        api_screen_x,
                        api_screen_y,
                        api_screen_width,
...
fn wire__crate__api__simple__handle_pointer_up_impl(
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartSse {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::SseCodec, _>(
        ...
        move || {
            ...
            transform_result_sse::<_, ()>((move || {
                ...
                let mut api_scene_guard = api_scene_guard.unwrap();
                let output_ok = Result::<_, ()>::Ok({
                    crate::api::simple::handle_pointer_up(&mut *api_scene_guard);
                })?;
                Ok(output_ok)
            })())
        },
